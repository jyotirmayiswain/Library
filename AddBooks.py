...
def bookRegister():
    ...
    insertBooks = "insert into "+bookTable+" values('"+bid+"','"+title+"','"+author+"','"+status+"','"+copies+"')"
    try:
...
def addBook(): 
    ...
    con = pymysql.connect(host="localhost",user="root",password='Jyotijojo@2000',database=mydatabase)
    cur = con.cursor()
    ...
    Canvas1.config(bg="#DAF7A6")#background color of the addbooks
    Canvas1.pack(expand=True,fill=BOTH)
        
    headingFrame1 = Frame(root,bg="#8E2E19",bd=5)
    ...
    #copies
    lb5 = Label(labelFrame,text="No. of copies : ", bg='black', fg='white')
